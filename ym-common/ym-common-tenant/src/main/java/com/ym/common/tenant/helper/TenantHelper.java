package com.ym.common.tenant.helper;
...
import com.ym.common.tenant.exception.TenantException;
...
public class TenantHelper {
    ...
    public static void setDynamic(String tenantId, boolean global) {
        ...
        if (!global || !SaHolder.getContext().isValid() || !LoginHelper.isLogin()) {
    ...
    public static String getDynamic() {
        ...
        if (!SaHolder.getContext().isValid() || !LoginHelper.isLogin()) {
            return null;
        }
    ...
    public static String getTenantId() {
        ...
        return SaHolder.getContext().isValid() ? LoginHelper.getTenantId() : null;
    }
