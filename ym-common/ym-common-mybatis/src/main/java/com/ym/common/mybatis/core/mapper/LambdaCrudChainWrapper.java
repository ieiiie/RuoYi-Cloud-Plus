package com.ym.common.mybatis.core.mapper;
...
import com.ym.common.mybatis.core.query.AggregateSelectUtils;
import com.ym.common.mybatis.core.query.LambdaQueryCondition;
import com.ym.common.mybatis.core.query.SqlAggregateFunction;
import com.ym.common.mybatis.core.query.SubQuery;
...
public class LambdaCrudChainWrapper<T, V> extends AbstractLambdaWrapper<T, LambdaCrudChainWrapper<T, V>>
    ...
    public LambdaCrudChainWrapper<T, V> setIfText(SFunction<T, ?> column, String value) {
        return set(com.ym.common.core.utils.StringUtils.isNotBlank(value), column, value);
    }
