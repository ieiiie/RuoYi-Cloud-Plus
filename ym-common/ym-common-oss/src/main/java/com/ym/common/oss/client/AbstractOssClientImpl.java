package com.ym.common.oss.client;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.IdUtil;
import com.ym.common.core.utils.DateUtils;
import com.ym.common.core.utils.StringUtils;
import com.ym.common.oss.config.OssClientConfig;
import com.ym.common.oss.exception.S3StorageException;
import com.ym.common.oss.io.OutputStreamDownloadSubscriber;
import com.ym.common.oss.model.GetObjectResult;
import com.ym.common.oss.model.HandleAsyncResult;
...
public abstract class AbstractOssClientImpl implements OssClient {
    ...
    public PutObjectResult bucketUpload(String bucket, String key, InputStream in, long contentLength, Options options) {
        Path tempFile = null;
        try {
            tempFile = Files.createTempFile("ym-oss-upload-", ".tmp");
