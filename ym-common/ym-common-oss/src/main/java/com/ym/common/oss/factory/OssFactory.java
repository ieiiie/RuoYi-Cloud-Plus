...
import com.ym.common.oss.properties.OssProperties;
...
public class OssFactory {
    ...
    /** 关闭并清空全部本地客户端，供运营端切换默认配置后热刷新。 */
    public static void clear() {
        for (String configKey : CLIENT_CACHE.keySet()) {
            remove(configKey);
        }
    }
