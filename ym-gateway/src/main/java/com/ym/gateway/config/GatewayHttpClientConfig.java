...
import com.ym.gateway.config.properties.GatewayHttpClientProperties;
...
public class GatewayHttpClientConfig {
    ...
    @Bean
    @RefreshScope
    public ClientHttpRequestFactory gatewayClientHttpRequestFactory(HttpClientSettings settings) {
