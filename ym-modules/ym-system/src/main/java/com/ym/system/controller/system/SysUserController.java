...
import com.ym.common.excel.core.ExcelResult;
...
import com.ym.system.domain.bo.SysDeptBo;
import com.ym.system.domain.bo.SysPostBo;
import com.ym.system.domain.bo.SysRoleBo;
import com.ym.system.domain.bo.SysUserBo;
import com.ym.system.domain.vo.*;
import com.ym.system.listener.SysUserImportListener;
...
public class SysUserController extends BaseController {
    ...
    private final SysLoginPermissionService loginPermissionService;
    ...
    public R<UserInfoVo> getInfo() {
        // 拿到与切换共用的 token 锁后才读取身份、查询权限并写回，禁止旧请求覆盖新租户。
        return LoginHelper.refreshLoginUser(loginUser -> {
            ...
            // 保留套餐/角色变更后的授权刷新，包括撤销权限。
            loginPermissionService.refresh(loginUser, user.getRoles());
