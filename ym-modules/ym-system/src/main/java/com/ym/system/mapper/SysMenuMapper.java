...
import com.ym.system.domain.vo.SysRoleMenuPermVo;
...
public interface SysMenuMapper extends BaseMapperPlus<SysMenu, SysMenuVo>, MPJBaseMapper<SysMenu> {
     ...
     * @return 权限列表
     */
    default Set<String> selectMenuPermsByUserId(Long userId, Collection<Long> menuIds) {
        List<SysMenu> list = this.selectJoinList(SysMenu.class, QueryBuilder.lambdaJoin("m", SysMenu.class)
            ...
            .in("m", SysMenu::getMenuId, menuIds)
     ...
     * @return 权限列表
     */
    default Set<String> selectMenuPermsByRoleId(Long roleId, Collection<Long> menuIds) {
        List<SysMenu> list = this.selectJoinList(SysMenu.class, QueryBuilder.lambdaJoin("m", SysMenu.class)
            .distinct()
            .select(SysMenu::getPerms)
            .leftJoin(SysRoleMenu.class, "srm", SysRoleMenu::getMenuId, SysMenu::getMenuId)
     ...
     * @return 角色权限映射
     */
    default Map<Long, Set<String>> selectMenuPermsByRoleIds(Collection<Long> roleIds, Collection<Long> menuIds) {
     ...
     * @return 菜单列表
     */
    default List<SysMenu> selectMenuTreeAll(Collection<Long> menuIds) {
        return this.lambda()
     ...
     * @return 选中菜单列表
     */
    default List<Long> selectMenuListByRoleId(Long roleId, boolean menuCheckStrictly, Collection<Long> menuIds) {
     ...
     * @return 菜单列表
     */
    default List<SysMenuVo> selectMenuListByUserId(SysMenuBo menu, Long userId, Collection<Long> menuIds) {
     ...
     * @return 菜单列表
     */
    default List<SysMenu> selectMenuTreeByUserId(Long userId, Collection<Long> menuIds) {
        return this.selectJoinList(SysMenu.class, QueryBuilder.lambdaJoin("m", SysMenu.class)
            ...
            .orderByAsc("m", SysMenu::getParentId)
            .orderByAsc("m", SysMenu::getOrderNum)
            .orderByAsc("m", SysMenu::getMenuId)
            .build());
    }
