...
insert into sys_user values(1761100000000000003, 1761000000000000108, 'test', '本部门及以下', 'sys_user', '', '', '0', null, '$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', '0', '0', '127.0.0.1', sysdate(), 1761000000000000103, 1761100000000000001, sysdate(), 1761100000000000003, sysdate(), null);
...
insert into sys_oss_config values (1761900000000000004, 'qcloud', 'XXXXXXXXXXXXXXX', 'XXXXXXXXXXXXXXX', 'ym-1240000000', '', 'cos.ap-beijing.myqcloud.com', '', 'N', 'ap-beijing', '1', 'N', '', 1761000000000000103, 1761100000000000001, sysdate(), 1761100000000000001, sysdate(), null);
...
-- Dbo 运营平台仅保留系统核心：清除初始化脚本中遗留的演示、生成器和第三方登录数据。
...
WHERE menu_id IN (1761400000000000003, 1761400000000000004, 1761400000000000005, 1761400000000000008,
                  ...
                  1761400000000000121, 1761400000000001055, 1761400000000001056, 1761400000000001057,
                  1761400000000001058, 1761400000000001059, 1761400000000001060,
                  1761400000000001500, 1761400000000001501, 1761400000000001502, 1761400000000001503,
                  1761400000000001504, 1761400000000001505, 1761400000000001506, 1761400000000001507,
                  1761400000000001508, 1761400000000001509, 1761400000000001510, 1761400000000001511);
...
DROP TABLE IF EXISTS test_tree, test_demo, gen_table_column, gen_table;
...
VALUES
    (1762400000000000000,'SaaS运营',0,2,'saas',NULL,'','N','Y','M','0','0','','ant-design:cloud-server-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,'操作ry-cloud权威库'),
    (1762400000000000100,'应用管理',1762400000000000000,1,'app','saas/app/index','','N','Y','C','0','0','saas:app:list','ant-design:appstore-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''),
    (1762400000000000200,'租户管理',1762400000000000000,2,'tenant','saas/tenant/index','','N','Y','C','0','0','saas:tenant:list','ant-design:team-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''),
    (1762400000000000300,'租户套餐',1762400000000000000,3,'tenant-package','saas/tenant-package/index','','N','Y','C','0','0','saas:tenant-package:list','ant-design:gift-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''),
    (1762400000000000400,'租户菜单',1762400000000000000,4,'menu','saas/menu/index','','N','Y','C','0','0','saas:menu:list','ant-design:menu-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''),
    (1762400000000000500,'全局字典',1762400000000000000,5,'dict','saas/dict/index','','N','Y','C','0','0','saas:dict:list','ant-design:book-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''),
    (1762400000000000600,'参数定义',1762400000000000000,6,'config-definition','saas/config-definition/index','','N','Y','C','0','0','saas:config-definition:list','ant-design:control-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''),
    (1762400000000000700,'OSS配置',1762400000000000000,7,'oss-config','saas/oss-config/index','','N','Y','C','0','0','saas:oss-config:list','ant-design:cloud-upload-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''),
    (1762400000000000800,'角色权限模板',1762400000000000000,8,'role-template','saas/role-template/index','','N','Y','C','0','0','saas:role-template:list','ant-design:safety-certificate-outlined','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,'');

INSERT INTO sys_menu
    (menu_id,menu_name,parent_id,order_num,path,component,query_param,is_frame,is_cache,menu_type,visible,status,perms,icon,active_menu,ext,create_dept,create_by,create_time,update_by,update_time,remark)
SELECT 1762410000000000000+(r.seq*100)+a.seq,CONCAT(r.title,a.title),r.menu_id,a.seq,'','','','N','Y','F','0','0',CONCAT('saas:',r.resource,':',a.action),'#','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,''
FROM (
  ...
  SELECT 8,1762400000000000800,'角色模板','role-template'
) r CROSS JOIN (
  SELECT 1 seq,'查询' title,'query' action UNION ALL
  SELECT 2,'新增','add' UNION ALL SELECT 3,'修改','edit' UNION ALL SELECT 4,'删除','remove'
) a;
INSERT INTO sys_menu
    (menu_id,menu_name,parent_id,order_num,path,component,query_param,is_frame,is_cache,menu_type,visible,status,perms,icon,active_menu,ext,create_dept,create_by,create_time,update_by,update_time,remark)
VALUES(1762410000000000890,'模板同步',1762400000000000800,5,'','','','N','Y','F','0','0','saas:role-template:sync','#','','',1761000000000000103,1761100000000000001,SYSDATE(),NULL,NULL,'');
