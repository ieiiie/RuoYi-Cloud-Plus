...
public record OssConfigChangeEvent(
     ...
     * @param configJson DBO 数据库中的完整配置 JSON
     * @return OSS 配置变更事件
     */
    public static OssConfigChangeEvent useDefault(String configKey, String configJson) {
        return new OssConfigChangeEvent(configKey, null, configJson, true);
    }
