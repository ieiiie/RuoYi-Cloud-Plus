...
import com.ym.system.api.MessageService;
import com.ym.common.push.dto.PushPayloadDTO;
import com.ym.system.api.model.RegisterBody;
import com.ym.system.api.model.SocialLoginBody;
        ...
        scheduledExecutorService.schedule(() -> {
            messageService.publishMessage(
                ...
                PushPayloadDTO.of(
                    ...
                    DateUtils.getTodayHour(new Date()) + "好，欢迎登录 YM-Cloud-Plus 运营平台",
                    null
                )
            );
        }, 5, TimeUnit.SECONDS);
